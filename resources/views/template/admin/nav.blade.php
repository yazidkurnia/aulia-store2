                                            ...
                                            <div role="menu"
                                                ...
                                                <ul class="message-menu">
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="{{ asset('template/admin/img/contact/1.jpg') }}"
                                                                    alt="">
                                                            </div>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="{{ asset('template/admin/img/contact/4.jpg') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="{{ asset('template/admin/img/contact/3.jpg') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="{{ asset('template/admin/img/contact/2.jpg') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
